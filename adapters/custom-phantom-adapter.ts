...
// Custom
function isTransactionVersion(
  value: string | number
): value is TransactionVersion {
  // implement logic to check if value is a valid TransactionVersion
  return true; // or false
}
export class CustomPhantomAdapter extends BaseMessageSignerWalletAdapter {
  ...
  supportedTransactionVersions: ReadonlySet<TransactionVersion> = new Set(
    ["legacy", 0].filter(isTransactionVersion)
  );
